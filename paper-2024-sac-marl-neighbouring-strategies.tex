...
The specific form of the multi-agent Q-function and the update rules depend on the chosen MARL algorithm (e.g., independent Q-learning, value decomposition methods~\cite{DBLP:conf/icml/SonKKHY19}).  
