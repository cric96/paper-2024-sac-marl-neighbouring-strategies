...
namely: $5$ different methods %% TODO check how many ex are discussed
...
%
The observation space of each agent consist of a tuple of three elements: %% TODO CHECK AGAIN
