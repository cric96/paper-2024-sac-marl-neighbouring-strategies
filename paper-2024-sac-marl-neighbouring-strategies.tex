...
\begin{figure}
  ...
  For simplicity, only two agents are represented. However, the model can easily be extended to the general case of N agents.}
...
\begin{figure}
  \centering
  \includegraphics[width=0.75\linewidth]{figures/episode_reward_mean.pdf}
  \includegraphics[width=0.75\linewidth]{figures/episode_len_mean.pdf}
