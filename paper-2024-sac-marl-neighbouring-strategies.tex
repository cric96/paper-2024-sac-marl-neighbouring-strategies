...
%
In this direction, reinforcement learning (RL)~\cite{sutton2018reinforcement} has emerged as a powerful paradigm for training agents to interact with their environment and learn optimal policies through trial and error.
%
Moving beyond single-agent settings, multi-agent reinforcement learning (MARL)~\cite{bucsoniu2010multi} extends RL to scenarios where multiple agents must collaborate or compete to achieve a common goal.
%
...
leading to the emergence of multi-agent deep reinforcement learning (MADRL)~\cite{gronauer2022multi}.
%
...
Many prominent approaches in this field employ a centralized training and decentralized execution paradigm
 (e.g., COMA~\cite{foerster2018counterfactual}, MAPPO~\cite{yu2022surprising}, MADPG), 
